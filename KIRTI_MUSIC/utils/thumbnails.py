...
async def get_thumb(videoid: str) -> str:
    ...
    frosted = Image.KIRTI_composite(panel_area, overlay)
    ...
    try:
        title_font = ImageFont.truetype("KIRTI_MUSIC/assets/font.ttf", 32)
        regular_font = ImageFont.truetype("KIRTI_MUSIC/assets/font2.ttf", 18)
    except OSError:
    ...
    # Icons
    icons_path = "KIRTI_MUSIC/assets/play_icons.png"
    ...
    # Add "KIRTI BOTS" top-right (default font)
    font = ImageFont.truetype("KIRTI_MUSIC/assets/font.ttf", 28)  # 
    text = "BADNAM BOTS"
