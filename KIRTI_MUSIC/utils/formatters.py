...
async def int_to_KIRTI(user_id: int) -> str:
    KIRTIbet = ["a", "b", "c", "d", "e", "f", "g", "h", "i", "j"]
    text = ""
    user_id = str(user_id)
    for i in user_id:
        text += KIRTIbet[int(i)]
...
async def KIRTI_to_int(user_id_KIRTIbet: str) -> int:
    KIRTIbet = ["a", "b", "c", "d", "e", "f", "g", "h", "i", "j"]
    user_id = ""
    for i in user_id_KIRTIbet:
        index = KIRTIbet.index(i)
        user_id += str(index)
    user_id = int(user_id)
    return user_id
