...
from KIRTI_MUSIC.utils.errors import capture_err
import httpx 
from pyrogram.types import InlineKeyboardButton, InlineKeyboardMarkup
...
✼ || [˹ᴋɪʀᴛɪ ꭙ ʙᴏᴛѕ˼ 💞](https://t.me/KIRTI_SUPPORT_GROUP) ||
...
async def start(_, msg):
    buttons = [
        ...
        [
          InlineKeyboardButton("• ʜєʟᴘ •", url="https://t.me/KIRTI_SUPPORT_GROUP"),
          InlineKeyboardButton("• 𝛅ᴜᴘᴘσʀᴛ •", url="https://t.me/KIRTI_SUPPORT_GROUP"),
          ],
[
