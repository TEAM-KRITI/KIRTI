            ...
            try:
                await msg.reply_photo(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            [
                                InlineKeyboardButton("• ᴊᴏɪɴ •", url="https://t.me/KIRTI_SUPPORT_GROUP"),
                                InlineKeyboardButton("• ᴊᴏɪɴ •", url="https://t.me/KIRTI_bot_update"),
                            ]
                        ]
                    )
                )
