...
from KIRTI_MUSIC.utils.inline import supp_markup
from KIRTI_MUSIC.utils.inline import close_markup
...
async def ping_com(client, message: Message, _):
    ...
    reply_markup=InlineKeyboardMarkup(
        ...
        [
            InlineKeyboardButton(
                text="⌯ sᴜᴘᴘᴏʀᴛ ⌯", url=f"https://t.me/KIRTI_SUPPORT_GROUP",
            ),
            InlineKeyboardButton(
                text="⌯ ᴜᴘᴅᴀᴛᴇ ⌯", url=f"https://t.me/KIRTI_bot_update",
            )
        ],
        [
            InlineKeyboardButton(
