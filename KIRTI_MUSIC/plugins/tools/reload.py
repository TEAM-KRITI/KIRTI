...
from KIRTI_MUSIC.utils.database import get_assistant, get_authuser_names, get_cmode
from KIRTI_MUSIC.utils.decorators import ActualAdminCB, AdminActual, language
from KIRTI_MUSIC.utils.formatters import KIRTI_to_int, get_readable_time
...
async def reload_admin_cache(client, message: Message, _):
    try:
        ...
        for user in authusers:
            user_id = await KIRTI_to_int(user)
