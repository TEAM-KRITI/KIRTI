...
from KIRTI_MUSIC import YouTube, app
from KIRTI_MUSIC.core.call import Sona
from KIRTI_MUSIC.misc import SUDOERS, db
from KIRTI_MUSIC.utils.database import (
    get_active_chats,
    get_lang,
    get_upvote_count,
    is_active_chat,
...
from KIRTI_MUSIC.utils.database import get_assistant
from KIRTI_MUSIC.utils.decorators.language import languageCB
from KIRTI_MUSIC.utils.formatters import seconds_to_min
from KIRTI_MUSIC.utils.inline import close_markup, stream_markup, stream_markup_timer
from KIRTI_MUSIC.utils.stream.autoclear import auto_clean
from KIRTI_MUSIC.utils.thumbnails import get_thumb
from config import (
    BANNED_USERS,
    SOUNCLOUD_IMG_URL,
    STREAM_IMG_URL,
